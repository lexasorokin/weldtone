...
namespace Drupal\board_meetings\Plugin\WebformHandler;
 ...
 *
 * @WebformHandler(
 *   id = "webform_payment_estimator_form_handler_bm",
 *   label = @Translation("Email list subscribe from board meeting"),
...
class ListSubscribe extends WebformHandlerBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state,
    ...
    if (!empty($values[$email_field_name])) {
      ...
      board_meetings_list_subscribe($config['list_id'], $values[$email_field_name]);
    }
