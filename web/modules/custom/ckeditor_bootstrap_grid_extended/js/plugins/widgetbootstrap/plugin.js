    ...
    init: function init(editor) {
      ...
      editor.widgets.add('widgetbootstrapTwoCol', {
        ...
        template: '<div class="row two-col">'
          + '<div class="col-sm-6 col-md-6 col-num-1"><p><img src="https://placehold.it/500x280&text=Image" /></p><p>Content</p></div>'
          + '<div class="col-sm-6 col-md-6 col-num-2"><p><img src="https://placehold.it/500x280&text=Image" /></p><p>Content</p></div>'
        + '</div>',
      ...
      editor.widgets.add('widgetbootstrapThreeCol', {
        ...
        template: '<div class="row three-col">'
          + '<div class="col-sm-4 col-md-4 col-num-1"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
          + '<div class="col-sm-4 col-md-4 col-num-2"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
          + '<div class="col-sm-4 col-md-4 col-num-3"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
        + '</div>',
      ...
      editor.widgets.add('widgetbootstrapFourCol', {
        ...
        template: '<div class="row four-col">'
          + '<div class="col-md-6 col-lg-3 col-num-1"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
          + '<div class="col-md-6 col-lg-3 col-num-2"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
          + '<div class="col-md-6 col-lg-3 col-num-3"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
          + '<div class="col-md-6 col-lg-3 col-num-4"><p><img src="https://placehold.it/400x225&text=Image" /></p><p>Text below</p></div>'
        + '</div>',
